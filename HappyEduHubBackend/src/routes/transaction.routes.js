 ...
 */
router.get("/transactions", authMiddleware, roleMiddleware([ROLE.ADMIN]), transactionController.findAll);
 ...
 */
router.delete("/transactions/:id", authMiddleware, roleMiddleware([ROLE.ADMIN]), transactionController.delete);
