 ...
 */
router.get("/receipts", authMiddleware, roleMiddleware([ROLE.ADMIN,ROLE.ACADEMIC_AFFAIR]), receiptController.findAll);
...
router.post(
	"/receipts",
	authMiddleware,
	roleMiddleware([ROLE.TEACHER, ROLE.ACADEMIC_AFFAIR, ROLE.ADMIN]),
 ...
 */
router.delete("/receipts/:id", authMiddleware, roleMiddleware([ROLE.ADMIN]), receiptController.delete);
