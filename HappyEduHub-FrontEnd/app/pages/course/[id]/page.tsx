    ...
    <div className="flex flex-col mb-8">
      ...
      <div className="flex flex-col md:flex-row">
              ...
              <>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">
                    {JSON.parse(course.teacher.portfolio).hoc_ham === 'Thạc sĩ'
                      ? 'ThS.'
                ...
                <div className="flex flex-col gap-2">
                  <span className="text-sm">
                    {JSON.parse(course.teacher.portfolio).teaching_philosophy}
                  </span>
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start px-12 lg:px-24 text-blue-500">
          <Button color="blue" className="w-2/3 my-5">
            Đăng ký
          </Button>
                ...
                return [
                  ...
                  ...[1, 2, 3, 4, 5, 6, 7].map((day) => {
                    if (
                      course?.shifts.find(
                        (courseShift) =>
                          courseShift.day === day && courseShift.shift === shift
                      )
                    ) {
                      return (
                        <CheckBoxRounded
